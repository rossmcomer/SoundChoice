...
<template>
  ...
  <select id="eventType" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
<h3 class="mb-5 text-lg font-medium text-gray-900 dark:text-white">Would you like to add the additional uplighting package for only $200 extra?</h3>
