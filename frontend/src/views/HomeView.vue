  ...
  <div class="relative h-full overflow-hidden">
    ...
    >
      <div class="relative w-4/5 h-auto max-w-2xl mb-8">
        ...
        >
          <button
            class="text-[var(--black-soft)] font-medium sm:text-xl text-xs bg-[var(--color6)] px-4 py-2 rounded-lg shadow-lg cursor-pointer hover:translate-0.5 animate-bounce"
          >
