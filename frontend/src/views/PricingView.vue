              ...
              >
                ...
                <h2 class="mb-5 text-[42px] font-bold" style="color: var(--black-soft)">
                  ...
                  <span
                    ...
                    v-if="plan.features.increment === '/hr'"
                    >{{ plan.features.increment }}</span
                  >
                </h2>
                <p
                ...
                <div v-if="plan.features.rate !== ''" class="flex flex-col gap-[14px]">
                  <p class="text-base text-body-color dark:text-dark-6">{{ plan.features.rate }}</p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    {{ plan.features.music }}
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    {{ plan.features.microphones }}
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    {{ plan.features.speakers }}
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    {{ plan.features.lighting }}
                  </p>
                </div>
                <div>
