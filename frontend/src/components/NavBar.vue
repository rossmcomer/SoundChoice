...
<template>
  <nav class="fixed w-full z-20 top-0 start-0">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div
        :class="['items-center justify-between w-full md:flex md:w-auto md:order-1', isOpen ? 'flex' : 'hidden']"
        id="navbar-sticky"
      >
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
          <li>
            <router-link to="/" class="block py-2 px-3 text-white rounded-sm nav-link-md" aria-current="page">
              Home
            </router-link>
          </li>
          <li>
            <router-link to="/about" class="block py-2 px-3 nav-link-md">
              About
            </router-link>
          </li>
          <li>
            <router-link to="/pricing" class="block py-2 px-3 nav-link-md">
              Pricing
            </router-link>
          </li>
          <li>
          ...
          <li>
            <router-link to="/media" class="block py-2 px-3 nav-link-md">
              Media
            </router-link>
          </li>
          <li v-if="!user">
          ...
          <li v-else>
            <router-link to="/logout" class="block py-2 px-3 nav-link-md">
              Logout
            </router-link>
          </li>
        </ul>
